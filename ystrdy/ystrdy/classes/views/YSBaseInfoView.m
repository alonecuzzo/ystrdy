...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_titleLabel setFont:[YSFontHelper getFont:YSFontRalewayMedium withSize:YSFontSizeSmall-3]];
        _titleLabel.textAlignment = NSTextAlignmentCenter;
        [_titleLabel setTextColor:[YSColorHelper ystrdayWhite]];
        [self addSubview:_titleLabel];
        
        _messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, _iconView.y + 70.0f, self.width - 20.0f, 200.0f)];
        [_messageLabel setBackgroundColor:[UIColor clearColor]];
        [_messageLabel setFont:[YSFontHelper getFont:YSFontRalewayExtraLight withSize:YSFontSizeSmall-6]];
